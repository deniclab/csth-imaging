...
z_flags <- read_csv('~/Dropbox/code/csth-imaging/output_files/lc3_wipi_timelapse_z_flags.csv')
...
n_cells <- for_plt %>% tbl_df %>% group_by(channel, cell_line, treatment) %>% summarise(n_cells = n())
View(n_cells)
