...
ggsave('~/Dropbox/code/csth-imaging/r_scripts/lc3_wipi_2_plots/lc3_wipi_2_foci_cts_violin.pdf',
...
ggsave('~/Dropbox/code/csth-imaging/r_scripts/lc3_wipi_2_plots/lc3_wipi_2_overlap_cts_violin.pdf',
  device=cairo_pdf(width=6, height=4))
