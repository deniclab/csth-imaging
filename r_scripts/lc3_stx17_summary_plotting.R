...
for_plt$treatment[for_plt$treatment == 'Tor'] <- '+Torin'
for_plt$treatment[for_plt$treatment == 'NoTreat'] <- '-Torin'
for_plt$treatment <- factor(for_plt$treatment, levels=c('-Torin','+Torin'))
...
ggplot(for_plt, aes(x=factor(treatment), y=count)) +
  ...
  labs(x='Treatment',
       ...
       title='Cell line')
ggsave('~/Dropbox/code/csth-imaging/r_scripts/lc3_stx17_plots/lc3_stx17_foci_cts_boxplot.pdf',
...
ggplot(for_plt, aes(x=treatment, y=overlap_count)) +
  ...
  labs(x='Treatment',
       ...
       title='Cell line')
ggsave('~/Dropbox/code/csth-imaging/r_scripts/lc3_stx17_plots/lc3_stx17_overlap_cts_boxplot.pdf',
       device=cairo_pdf(width=7.5, height=4), useDingbats=FALSE)
