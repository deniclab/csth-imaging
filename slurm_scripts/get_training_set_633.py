...
czi_vector = np.random.randint(0, 15, 500)
...
for i in np.unique(czi_vector):
    ...
    for j in range(0, c_ims.shape[0]):
        ...
        io.imsave('/n/denic_lab/Lab/csth-output/svm_train_633/' +
        ...
        grad_arr[:, ind] = hist
        ind = ind + 1
np.save('/n/denic_lab/Lab/csth-output/svm_train_633/svm_training_set.npy',
        grad_arr)
